        ...
        <form action="<?= BASE_URL ?>login/login" method="POST" class="d-flex flex-column gap-3 p-2">
          <div class="w-100 d-flex justify-content-center pt-2  h-100">
            <div class="d-flex flex-row gap-3 pt-2 pb-2 h-100 search__component border border-secondary">
              ...
              <input class="form-control form-control-dark w-100" name="username" type="text" placeholder="Your username..." id="input__username--login" value="" required>
            </div>
          </div>
          <div class="w-100 d-flex justify-content-center pt-2 pb-2 h-100">
            <div class="d-flex flex-row gap-3 pt-2 pb-2 h-100 search__component border border-secondary">
              ...
              <input class="form-control form-control-dark w-100" name="password" type="password" placeholder="Your password..." id="input__password--login" value="" required>
            </div>
          </div>
